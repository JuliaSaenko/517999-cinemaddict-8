...
import {ENTER_KEYCODE} from './util';
      ...
      <form class="film-details__inner" action="" method="get">
        ...
        <div class="film-details__info-wrap">
            ...
            <div class="film-details__info-head">
              <div class="film-details__title-wrap">
               ...
               <div class="film-details__rating">
                ...
                <p class="film-details__user-rating"><span>${this._userRating}</span></p>
              </div>
            </div>
         ...
         <section class="film-details__comments-wrap">
          <h3 class="film-details__comments-title">CommentsComment${this._comments.length > 1 ? `s` : ``} <span class="film-details__comments-count">${this._comments.length}</span></h3>
